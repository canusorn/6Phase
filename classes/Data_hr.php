...
class Data_hr
{
    ...
    public function createTables()
    {
        $commands = [
            ...
            'CREATE INDEX IF NOT EXISTS time_index ON \'hr\' (time);'
        ];
        //var_dump($commands);
    ...
    {
        $sql = "INSERT INTO 'hr' VALUES(:v1,:i1,:p1,:e1,:f1,:pf1,:v2,:i2,:p2,:e2,:f2,:pf2,:v3,:i3,:p3,:e3,:f3,:pf3,:v4,:i4,:p4,:e4,:f4,:pf4,:v5,:i5,:p5,:e5,:f5,:pf5,:v6,:i6,:p6,:e6,:f6,:pf6,:time)";
    ...
    public static function getLast($esp_id, $limit = 1, $columns = '*')
    {
        ...
        $sql = "SELECT $columns FROM 'hr' ORDER BY time DESC LIMIT {$limit}";
